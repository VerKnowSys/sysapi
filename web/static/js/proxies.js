...
<div class=\"brand-card\"> \
  ...
  <div class=\"brand-card-body\"> \
      ...
      <a href=\"#\" class=\"badge\"><div onclick=\"return confirm('Are you sure you wish to destroy this Proxy?');\" name=\"__NAME__\" from=\"__FROM__\" to=\"__TO__\" class=\"delete_proxy text-value cui-circle-x\"></div></a> \
  </div> \
  <div class=\"brand-card-body\"> \
    <div> \
